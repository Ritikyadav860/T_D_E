...
public class Check_to_proceed extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check_to_proceed = findViewById(R.id.btn_checkout);
        check_to_proceed.setOnClickListener(new View.OnClickListener() {
            @Override
...
// Make a toast which displays the route's distance
                Toast.makeText(Check_to_proceed.this, String.format(
