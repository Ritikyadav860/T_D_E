...
public class MainPage extends AppCompatActivity implements PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), enter_destination.class);
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull final MapboxMap mapboxMap) {
                MainPage.this.mapboxMap = mapboxMap;
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        Toast.makeText(MainPage.this, "loaded map", Toast.LENGTH_SHORT).show();
                ...
                mapboxMap.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
                    ...
                    public boolean onMapClick(@NonNull LatLng point) {
                        ...
                        Toast.makeText(MainPage.this, String.format("User clicked at: %s", point.toString()), Toast.LENGTH_LONG).show();
    ...
    public void onPermissionResult(boolean granted) {
        Toast.makeText(MainPage.this, "status" + granted, Toast.LENGTH_SHORT).show();
    }
